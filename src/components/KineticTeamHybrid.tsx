...
const TEAM: TeamMember[] = [
  {
    id: '01',
    name: 'Obys Agency',
    role: 'Interaction & Creative Studio',
    image: 'https://images.unsplash.com/photo-1542435503-956c469947f6?q=80&w=1000&auto=format&fit=crop',
  },
  {
    id: '02',
    name: 'Alphamark Design',
    role: 'Brand Identity & Web Systems',
    image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?q=80&w=1000&auto=format&fit=crop',
  },
  {
    id: '03',
    name: 'Plus Studio',
    role: 'Creative Tech & Experiential',
  ...
  },
  {
    id: '05',
    name: 'Nandez Design',
    role: '3D Motion & Spatial Layouts',
    image: 'https://images.unsplash.com/photo-1618005198143-d528f85f82ee?q=80&w=1000&auto=format&fit=crop',
  },
];
...
export default function KineticTeamHybrid() {
  ...
  return (
    <div
      ...
      className="relative w-full cursor-default bg-black px-6 py-24 text-neutral-200 md:px-12 border-t border-white/5"
    >
      {/* Background Ambience */}
        ...
        >
          <div>
            <h1 className="text-4xl font-light tracking-tighter text-white sm:text-6xl md:text-8xl">
              Creative <span className="text-neutral-600 font-playfair italic">Talent</span>
            </h1>
          </div>
          <div className="h-px flex-1 bg-neutral-900 mx-8 hidden md:block" />
          <p className="text-xs font-medium uppercase tracking-[0.3em] text-[#e8702a]">
            Selected Works &apos;24
          </p>
        </motion.header>
              ...
              >
                ...
                <div className="absolute bottom-0 w-full bg-gradient-to-t from-black/80 to-transparent p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] uppercase tracking-widest text-white/80 font-mono">Active</span>
                  </div>
                </div>
              </motion.div>
            )}
